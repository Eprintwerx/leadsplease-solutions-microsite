// CloudFront viewer-request function for the /solutions-hub/* behavior on
// distribution E39WJRUVOH25A4. Files are stored in S3 under the key prefix
// solutions-hub/. Internal links in the HTML already include the prefix, so
...
function handler(event) {
    ...
    if (uri === '/solutions-hub') {
        return {
            statusCode: 301,
            statusDescription: 'Moved Permanently',
            headers: { location: { value: '/solutions-hub/' } }
        };
    }
    if (uri.endsWith('/')) {
